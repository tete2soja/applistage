...
<div style="width:90%;
	...
	<hr />
	<p>Si l'entreprise vous à fourmi la convention, cliquez sur 'Entreprise', sinon cliquez sur 'Etudiant'.</p>
	...
	<form class="form-horizontal" id="formulaire_etudiant" role="form" method="POST" action="" value="submit" onsubmit="return checkform();">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<select class="form-control">
					<?php 
						if(isset($stage))
							echo '<option>offre_iut</option>';
						else {
					 		echo '<option>offre_iut</option>';
							echo '<option>etudiant</option>';
						}
					?>
				</select>
			</div>
		...
		<div class="form-group" id="adresse_stage">
			...
			<div class="col-sm-10">
				<select id="langue_conv" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<select id="type_conv" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<div class="input-append date" id="date_debut_div" data-date=<?php echo '"' . $date_debut .'"'; ?> data-date-format="yyyy-mm-dd">
					<input id="date_debut" class="span2" size="16" type="text" value=<?php echo '"' . $date_debut .'"'; ?> readonly>
					<span class="add-on">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<div class="input-append date" id="date_fin_div" data-date=<?php echo '"' . $date_fin .'"'; ?> data-date-format="yyyy-mm-dd">
					<input id="date_fin" class="span2" size="16" type="text" value=<?php echo '"' . $date_fin .'"'; ?> readonly>
					<span class="add-on">
						<i class="glyphicon glyphicon-leaf"></i>
					</span>
				</div>
